...
class FileScheduler
  ...
  #
  #             # ICMS
  #             icms_info = doc.xpath("//declaracaoImportacao//icms")
  #
  #             icms_info.each do |info|
  #
  #               # Numero DI
  #               numero_di = di_info.at_css('numeroDI')
  ...
  #               cod_tipo_recolhimento_icms = info.at_css('codigoTipoRecolhimentoIcms')
  ...
  #           f.read_count += 1
  #
  #           App::DATASOURCE.after_commit do
  #             f.status = 'PROCESSED'
  #             f.save
  #           end
  #
  #           App::DATASOURCE.after_rollback do
  #             f.status = 'ERROR'
  #             f.save
  #           end
  #         end
